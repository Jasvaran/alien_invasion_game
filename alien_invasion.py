...
class AlienInvasion:
	...
	def __init__(self):
		...
		self.difficulty_button = DifficultyButton(self, "Hard Mode")
	...
	def _check_difficulty_button(self, mouse_pos):
		"""Change difficulty when player clicks Hard Mode."""
		if self.difficulty_button.rect.collidepoint(mouse_pos):
			button_pressed = self.difficulty_button.rect.collidepoint(mouse_pos)
